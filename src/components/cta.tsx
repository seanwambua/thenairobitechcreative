    ...
    <section id="contact" className="py-20 lg:py-24">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl bg-[linear-gradient(90deg,hsl(var(--secondary))_0%,hsl(var(--primary))_50%,hsl(var(--secondary))_100%)] p-8 text-center md:p-12"
        >
